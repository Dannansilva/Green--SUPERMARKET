        ...
        <div className=" flex flex-col px-[20px] py-[px] sm:m-1 lg:m-1 shadow-2xl lg:w-1/4 xl:w-1/6  rounded-md shadow-Lightgray lg:max-h-[350px]  ">
          <div className=" items-center sm:justify-between text-center my-2 w-full ">
            ...
            <div className=" text-Gray3 flex flex-row justify-center">
              <p className="sm:text-xs font-normal ">
          ...
          <div className=" items-center sm:justify-between text-center my-2  ">
            ...
            <div className="items-center text-center text-Gray3 sm:text-xs">
              <p>{`(+94) 762630010`}</p>
            </div>
            <div className="items-center text-center text-Gray3 flex flex-row justify-center sm:pb-[20px] sm:text-xs">
              <span>
                <p>{`Hotline: `}</p>
              </span>
              <span>
