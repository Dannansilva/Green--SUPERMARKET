...
const Productesdetails = () => {
  ...
  return (
    ...
    //         <h1 className="text-zinc-900 text-4xl font-semibold leading-[43.20px]">
    //           Cabbage{" "}
    //         </h1>
    //         <div className="w-[71px] h-[29px] px-2 py-1 bg-green-600 bg-opacity-20 rounded justify-center items-center gap-2.5 inline-flex">
    //           <div className="text-green-800 text-sm font-normal  leading-[21px]">
    //             In Stock
    //           </div>
    //         </div>
    //       </div>
    ...
    //           <IoStarSharp />
    //           <IoStarSharp />
    //           <div className="text-stone-500 text-sm font-normal  leading-[21px]">
    //             {" "}
    //             4 Review
    //           </div>
    //         </div>
    ...
    //         <div className="text-zinc-400 text-xl font-normal  line-through leading-[30px  ">
    //           LKR150.00
    //         </div>
    //         <div className="text-green-800 text-2xl font-medium  leading-9">
    //           LKR96.00
    //         </div>
    //         {/* discount */}
    ...
    //           <div className="text-red-500 text-sm font-medium leading-[21px]">
    //             25% Off
    //           </div>
    //         </div>
    //       </div>
