...
const TopProducts = [
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Green apple</p>,
    price: "LKR 140.00",
  ...
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Cabbage</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className=" " />,
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Green Lettuce</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className="" />,
  },
  
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Eggplant</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className=" " />,
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Potatoes</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className="  " />,
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Sweet potato</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className=" " />,
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Fresh Cauliflower</p>,
    price: "LKR 120.00",
  ...
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Green Capsicum</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className=" " />,
  },
  {
    ...
    productname: <p className=" text-Lightgray hover:text-DarkGreen ">Green Chili</p>,
    price: "LKR 120.00",
    image2: <SlHandbag className=" " />,
  },
];
  ...
  return (
    <div className="sm:mx-2 md:mx-16 lg:mx-24 xl:mx-36 mb-10 md:mt-[60px]  ">
      ...
      <div className="  grid grid-cols-1 place-items-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 pt-5">
        {TopProducts.map(
          ({ id, sale, image, productname, price, image2 }) => (
            <div
              key={id}
            ...
            >
              ...
              <div className="flex flex-row items-center justify-between">
                ...
                <div className="items-center">
                 <button className="items-center rounded-full bg-Lightgray2 text-black  hover:text-white hover:bg-Green p-3"> {image2}</button>
                 </div>
